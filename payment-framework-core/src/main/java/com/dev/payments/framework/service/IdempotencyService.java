...
public class IdempotencyService {
    ...
    public ProcessingResult processMessage(
        ...
        return processingTimer.record(() -> {
            ...
            try {
                ...
                throw new IllegalStateException("Failed to serialize outbox payload for key: " + idempotencyKey, e);
            }
    ...
    public record ProcessingResult(
        ...
        public ProcessedEvent getEvent() { return event; }
        public OutboxEntry getOutboxEntry() { return outboxEntry; }
    }
}
