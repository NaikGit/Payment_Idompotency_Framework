...
public class DeliveryService {
    ...
    public DeliveryResult deliver(OutboxEntry entry) {
        ...
        try {
            switch (entry.getDestination().toUpperCase()) {
                case "MESSAGING":
    ...
    public static class DeliveryResult {
        ...
        private DeliveryResult(boolean success, boolean permanentFailure, 
                               String error, Integer httpStatus, long durationMillis) {
